...
import classes from './Warden.module.css'
    ...
    return (
        <div className={classes.page}>
             <div>
                ...
                <div className={classes.mainTable}><div className={classes.tit}>REBATE Requests</div>

                    <BootstrapTable keyField='applied' data={dat} columns={columns} hover striped pagination={pagination}></BootstrapTable></div>
            </div>
            {showDd &&
