...
import classes from './ManageTransactions.module.css'
...
import add from '../../assets/addtrans.png'
import update from '../../assets/updatetrans.png'
import archive from '../../assets/deltrans.png'
        ...
        <div className={classes.page}>
            <div>
                ...
                <div className={classes.mainTable}>
                    <h3 className={classes.h}>Manage Transactions</h3>
                    <div className={classes.col}>
                        <div  onClick={() => { window.location.pathname = "/addtrans"; }}className={classes.card}>
                            <div className={classes.vector}><img className={classes.img} src={add} ></img></div>
                            <div className={classes.head}>Add Transaction(s)</div>
                        </div>
                    </div>
                    <div className={classes.col}>
                        <div onClick={() => { window.location.pathname = "/deltrans"; }}className={classes.card}>    <div className={classes.vector}><img className={classes.img}src={archive} ></img></div>
                            <div className={classes.head}>Delete Transaction</div>
                        </div>
                    </div>
                    <div className={classes.col}>
                        <div onClick={() => { window.location.pathname = "/updatetrans"; }} className={classes.card}>
                            <div className={classes.vector}
                            ><img className={classes.img} src={update} ></img>
                            </div>
                            <div className={classes.head}>Update Transaction</div>
                        </div>
                    </div>
                </div>
                </div>
